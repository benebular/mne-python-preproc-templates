...
for subject in subjects:
    ...
    meg_dir = '/Volumes/hecate/biphon/dec/%s/'%(subject)
...
subject = 'A0417' # change subject and follow steps below to apply each individual ICA and select bad compoenents manually
